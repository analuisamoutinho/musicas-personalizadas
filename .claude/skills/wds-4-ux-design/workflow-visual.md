...
**When to use:** When the user wants to create or review visual mockups, prototypes, or design artifacts using tools like Figma, Nano Banana, or Pencil.io.
...
- **Figma** — Professional design tool integration- **Pencil.io** — Quick wireframing
