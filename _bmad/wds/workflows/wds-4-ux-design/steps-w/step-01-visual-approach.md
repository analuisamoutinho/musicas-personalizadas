...
[N] Nano Banana Assets — AI-generated images and mood visuals (hero photos, card images, placeholders)[F] Figma — Professional design tool (precise, production-ready)
...
3. Use [H] HTML Prototype for production mockups with real text and code
