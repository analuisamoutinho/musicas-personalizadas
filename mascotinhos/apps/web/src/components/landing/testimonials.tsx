const testimonials = [
  {
    quote: "Eu mandei nossa história em poucos minutos e chorei quando recebi a letra. Parecia que alguém tinha vivido tudo com a gente.",
    name: "Juliana Souza",
    city: "São Paulo, SP",
  ...
  {
    quote: "Presenteei minha esposa no aniversário de casamento. Foi o presente mais emocionante que já dei.",
    name: "Rafael Mendes",
  ...
  {
    quote: "Transformei a história do meu pai em uma música. A família inteira se emocionou.",
...
export default function Testimonials() {
  return (
    <section aria-label="Depoimentos" className="relative z-[1] px-4 py-20 md:py-24">
      <div className="mx-auto max-w-6xl text-center">
        ...
        <h2 className="font-headline font-extrabold tracking-[-0.03em] leading-[1.05] text-on-surface text-[clamp(2.25rem,5vw,4rem)] mt-1.5 mb-12">
          ...
          <span className="text-primary">emocionaram</span>.
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-md md:max-w-none mx-auto">
          {testimonials.map((t) => (
            ...
            >
              ...
              <blockquote className={`font-script font-medium text-2xl leading-[1.3] mb-4 ${t.text}`}>
                &ldquo;{t.quote}&rdquo;
              </blockquote>
