// Sets minimum required env vars for unit tests in the web app.
...
// Pattern from packages/bot-engine/src/test-setup.ts
...
process.env['VERCEL_URL'] = 'test.vercel.app'; // hostname-only — matches real Vercel VERCEL_URL format (no https:// prefix)
